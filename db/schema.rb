...
ActiveRecord::Schema.define(version: 20171020162614) do
  ...
  create_table "github_repositories", force: :cascade do |t|
    ...
    t.string   "name"
    t.string   "full_name"
    t.integer  "github_repository_owner_id"
    t.boolean  "private"
    t.string   "html_url"
  ...
  add_index "github_repositories", ["github_repository_owner_id"], name: "index_github_repositories_on_github_repository_owner_id", using: :btree
